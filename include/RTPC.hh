...
public:
  ...
  virtual void SetMagField(G4LogicalVolume*);
...
protected:
  ...
  G4double fRHe1,fRHe2,fRw,fOvHe;       // He radii and wire radius
  //G4double fRblI,fRblO;               // inner outer beam line radius
  G4double fRbl,fTbl,fSbl,fZbl;         // inner outer beam line radius
  G4double fORin,fORout,fOZ,fOTh;       // outer chamber dimensions
  G4double fWTh;                        // "Be" window thickness
  G4int fWMat;                          // window thickness
