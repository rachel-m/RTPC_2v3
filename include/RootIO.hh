...
protected:
  ...
  G4float *fArr_tof;  // time of flight of hit//===================HERE
  G4float *fArr_tstart;  // global start time of hit//===================HERE
  G4float *fArr_tend;  // global end time of hit 1st step//================HERE
  G4int *fArr_ptype;  // global end time of hit 1st step//================HERE
  ...
  G4float *fStPostZ;
  G4float *fStTOF;//=================HERE
  G4float *fStTstart;//=================HERE
  G4float *fStTend;//=================HERE
  TH3D* fH3[8];
  TH2D* fH2[8];
  TH1D* fH1[8];
  TH2D* fH2s;
