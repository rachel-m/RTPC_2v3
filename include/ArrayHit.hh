...
struct HitStep{
  ...
  G4double TOF; // time of flight of step================HERE
  G4double TStart; // global start time of step================HERE
  G4double TEnd; // global end time of step================HERE
};
...
protected:
  ...
  G4double fTOF;      // time of flight of step===============================HERE
  G4double fTStart;      // start of step===============================HERE
  G4double fTEnd;      // end of step===============================HERE
  G4double fPtype;      // ===============================HERE
...
public:
  ...
  inline void SetTOF(G4double t) {fTOF = t;};//===========================HERE
  inline void SetTStart(G4double t) {fTStart = t;};//=====================HERE
  inline void SetTEnd(G4double t) {fTEnd = t;};//========================HERE
  inline void SetPtype(G4int p) {fPtype = p;};//========================HERE
  ...
  inline G4bool AddStep(G4int trid, G4int parid, G4int stepid, G4double de,
			...
			G4ThreeVector* post, G4double tof, G4double tstart, G4double tend)//=====HERE
  {
  ...
  inline G4double    GetTOF()   { return fTOF; };//==============HERE
  inline G4double    GetTStart()   { return fTStart; };//==============HERE
  inline G4double    GetTEnd()   { return fTEnd; };//==============HERE
  inline G4double    GetPtype()   { return fPtype; };//==============HERE
